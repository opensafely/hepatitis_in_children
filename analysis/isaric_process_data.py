...
parser.add_argument('-o', '--output_filename', help='output filename', default=os.path.join(scriptpath, "summary_table.csv"))
...
AST_ALT_stats = create_AST_ALT_stats(df, args.output_filename)
